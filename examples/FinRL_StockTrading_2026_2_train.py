...
# --- Agent 1: A2C ---
if if_using_a2c and os.path.exists(TRAINED_MODEL_DIR + "/agent_a2c.zip"):
    print("Agent a2c already trained, skipping:", TRAINED_MODEL_DIR + "/agent_a2c.zip")
else:
...
# --- Agent 2: DDPG ---
if if_using_ddpg and os.path.exists(TRAINED_MODEL_DIR + "/agent_ddpg.zip"):
    print("Agent ddpg already trained, skipping:", TRAINED_MODEL_DIR + "/agent_ddpg.zip")
else:
    agent = DRLAgent(env=env_train)
...
# --- Agent 3: PPO ---
if if_using_ppo and os.path.exists(TRAINED_MODEL_DIR + "/agent_ppo.zip"):
    print("Agent ppo already trained, skipping:", TRAINED_MODEL_DIR + "/agent_ppo.zip")
else:
    agent = DRLAgent(env=env_train)
    PPO_PARAMS = {
        "n_steps": 2048,
...
# --- Agent 4: TD3 ---
if if_using_td3 and os.path.exists(TRAINED_MODEL_DIR + "/agent_td3.zip"):
    print("Agent td3 already trained, skipping:", TRAINED_MODEL_DIR + "/agent_td3.zip")
else:
    agent = DRLAgent(env=env_train)
    TD3_PARAMS = {
        "batch_size": 100,
...
# --- Agent 5: SAC ---
if if_using_sac and os.path.exists(TRAINED_MODEL_DIR + "/agent_sac.zip"):
    print("Agent sac already trained, skipping:", TRAINED_MODEL_DIR + "/agent_sac.zip")
else:
    agent = DRLAgent(env=env_train)
    SAC_PARAMS = {
        "batch_size": 128,
